...
export default function JobAdFilter({ clickEvent }) {
    ...
    return (
        <div>
            <Segment style={{ backgroundColor: 'white' }} raised>
                <Dropdown
            ...
            <Segment raised>
                <Label style={{ backgroundColor: 'skyblue', color: 'black' }} attached="top" size="large">İş Pozisyonu</Label>
                {
            ...
            <Segment raised>
                <Label style={{ backgroundColor: 'skyblue', color: 'black' }} attached="top" size="large">Çalışma Yeri</Label>
                {
            ...
            <Segment raised>
                <Label style={{ backgroundColor: 'skyblue', color: 'black' }} attached="top" size="large">Çalışma Süresi</Label>
                {
