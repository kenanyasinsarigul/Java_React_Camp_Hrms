...
export default function JobAdCreate() {
    ...
    return (
        <div>
            ...
            {authItem[0].user.userType === 2 &&
                <Card fluid>
                    <h3 style={{ margin: '1em' }}>YENİ İLAN EKLE</h3>
                    <Card.Content>
                        <Form onSubmit={formik.handleSubmit}>
                            <Form.Field style={{ marginBottom: "1rem" }}>
                                <label style={{ marginBottom: '1em' }}>POZİSYON</label>
                                <Dropdown
                                    clearable
                                    item
                            ...
                            <Form.Field>
                                <label style={{ marginBottom: '1em' }}>ŞEHİR</label>
                                <Dropdown
                                    clearable
                                    item
                                    placeholder="Şehir"
                            ...
                            <Form.Field>
                                <label style={{ marginBottom: '1em' }}>ÇALIŞMA YERİ</label>
                                <Dropdown
                                    clearable
                                    item
                            ...
                            <Form.Field>
                                <label style={{ marginBottom: '1em' }}>ÇALIŞMA SÜRESİ</label>
                                <Dropdown
                                    clearable
                                    item
                            ...
                            <Form.Field>
                                <label style={{ marginBottom: '1em' }}>Açıklama</label>
                                <TextArea
