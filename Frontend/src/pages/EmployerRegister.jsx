            ...
            <Form size="large" onSubmit={formik.handleSubmit}>
                <Segment>
                    ...
                    <Grid stackable>
                        <Grid.Column width={8}>
                            <div style={{ marginTop: "1em" }}>
                                <label><b>TELEFON NUMARASI</b> (Sıfır olmadan yazınız)</label>
                                <Form.Input
                                    fluid
                                    style={{ marginTop: '1em' }}
                                    icon="phone"
                            ...
                            <div style={{ marginTop: "1em" }}>
                                <label><b>E-MAİL</b> (Web sitesi domaini ile aynı domaine sahip olmalıdır)</label>
                                <Form.Input
                                    fluid
                                    style={{ marginTop: '1em' }}
                                    icon="mail"
                        ...
                        <Grid.Column width={8}>
                            <div style={{ marginTop: "1em" }}>
                                <label><b>WEB SİTESİ</b> (http:// olmadan yazınız)</label>
                                <Form.Input
                                    fluid
                                    style={{ marginTop: '1em' }}
                                    icon="world"
