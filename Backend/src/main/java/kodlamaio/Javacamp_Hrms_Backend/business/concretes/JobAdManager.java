...
import kodlamaio.Javacamp_Hrms_Backend.business.abstracts.JobAdService;
import kodlamaio.Javacamp_Hrms_Backend.core.utilities.results.*;
import kodlamaio.Javacamp_Hrms_Backend.dataAccess.abstracts.*;
...
public class JobAdManager implements JobAdService {
    ...
    public DataResult<List<JobAd>> getAll() {
        return new SuccessDataResult(this.jobAdDao.findAll(),"Data listelendi");
    }
